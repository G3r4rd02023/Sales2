...
namespace Sales.API.Data
{
    public class SeedDb
    {
        ...
        public SeedDb(DataContext context, IUserHelper userHelper, IApiService apiService,IFileStorage fileStorage)
        {
            _context = context;
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1010", "Gerardo", "Lanza", "gerardo@yopmail.com", "322 311 4620", "Calle Luna Calle Sol", "Gerardo.jpg", UserType.Admin);
